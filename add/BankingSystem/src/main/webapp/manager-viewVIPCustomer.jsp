...
<title>VIP Customer Management</title>
<!-- Font Awesome -->
<link rel="stylesheet"
		...
		<nav id="sidebarMenu"
			...
			<div class="position-sticky">
				<div class="list-group list-group-flush mx-3 mt-4">
					...
					<a href="/BankingSystem/create-staff-account"
						class="list-group-item list-group-item-action py-2 ripple "><i
						class="fas fa-users fa-fw me-3"></i><span>Create Staff Account</span></a> 
						
						<a
						href="/BankingSystem/vip-customer"
						class="list-group-item list-group-item-action py-2 ripple active"><i
						class="fas fa-building fa-fw me-3"></i><span>VIP Customer Management</span></a>
				</div>
			</div>
		</nav>
		<!-- Sidebar -->
						...
						<div class="card mask-custom">
							<div class="card-body p-4 text-white">
								...
								<table class="table text-white mb-0">
									...
									<tbody>
										<c:forEach items="${requestScope.listVipCustomer }"
											var="customer">
											<tr class="fw-normal">
												...
												<td class="align-middle"><a href="/BankingSystem/RemoveVipStatus?action=remove&id=${customer.customerId }"
													data-mdb-toggle="tooltip" title="Remove Vip Status"><i
